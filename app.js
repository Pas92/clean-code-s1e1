...
var taskInput = document.querySelector(".new-task__input-text");//Add a new task.
var addButton=document.querySelector(".new-task__button");//first button
var incompleteTaskHolder=document.querySelector(".tasks__list.todo-tasks__list");//ul of #incompleteTasks
var completedTasksHolder=document.querySelector(".tasks__list.completed-tasks__list");//completed-tasks
...
var createNewTaskElement=function(taskString){
    ...
    listItem.className = 'tasks__item todo-tasks__item'

    label.innerText=taskString;
    label.className='tasks__label todo-tasks__label';
    ...
    editButton.className="button tasks__button_edit edit";

    deleteButton.className="button tasks__button_delete delete";
...
var editTask=function(){
    ...
    var editBtn=listItem.querySelector(".button.tasks__button_edit");
...
var taskCompleted=function(){
    ...
    label.classList.toggle('todo-tasks__label')
